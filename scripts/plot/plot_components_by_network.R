...
for (j in 1:length(netnames)) {
  df <- read.csv(paste0(indir, 'tabulated/variance_explained_j', j, '_svd.csv'))
...
pdf(paste0('/projects/b1108/projects/personalized_versus_group/plots/combined_variance_explained_by_network_svd.pdf'), width = 8, height = 6) 
plot1
dev.off()

pdf(paste0('/projects/b1108/projects/personalized_versus_group/plots/combined_cumulative_variance_explained_by_network_svd.pdf'), width = 8, height = 6) 
plot2
dev.off()
...
pdf(paste0('/projects/b1108/projects/personalized_versus_group/plots/combined_variance_explained_by_network_svd_10.pdf'), width = 6, height = 6) 
plot1
dev.off()

pdf(paste0('/projects/b1108/projects/personalized_versus_group/plots/combined_cumulative_variance_explained_by_network_svd_10.pdf'), width = 6, height = 6) 
plot2
dev.off()
