...
#SBATCH --time=00:40:00                                   ## how long does this need to run (remember different partitions have restrictions on this param)
...
#SBATCH --job-name="maxpostproc"                          ## use the task id in the name of the job
