...
GPARC <- readRDS('/projects/b1108/projects/personalized_versus_group/data/processed/neuroimaging/prior/GPARC.rds')
...
paths <- system(paste0('find ', indir, 'surf/sub-*/ses-1/func/ -name "*_task-chatroom_run-01_space-fsLR_desc-maxpostproc_bold.dscalar.nii"'), intern=TRUE)
