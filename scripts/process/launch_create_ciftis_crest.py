...
indir = '/projects/b1108/studies/crest/data/processed/neuroimaging/fmriprep_23.2.0/'
...
for subdir in subdirs:
    ...
    if len(sub_bold_imgs) > 0 and len(output_imgs) == 0:
        print(sub)
        cmd = ['bash /projects/b1108/projects/personalized_versus_group/scripts/process/create_ciftis_crest.sh -s', sub]
