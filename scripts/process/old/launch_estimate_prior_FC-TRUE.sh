...
Rscript /projects/b1108/projects/personalized_versus_group/scripts/process/estimate_prior_FC-TRUE.R

#sbatch -o /projects/b1108/projects/personalized_versus_group/data/processed/neuroimaging/launch/prior/estimate_prior_FC-TRUE.txt /projects/b1108/projects/personalized_versus_group/scripts/process/launch_estimate_prior_FC-TRUE.sh