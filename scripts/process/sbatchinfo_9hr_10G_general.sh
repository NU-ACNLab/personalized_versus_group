...
#SBATCH --time=09:00:00                                   ## how long does this need to run (remember different partitions have restrictions on this param)
...
#SBATCH --job-name="9hr"                                  ## use the task id in the name of the job
