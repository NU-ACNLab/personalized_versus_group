...
###
### Ellyn Butler
### October 16, 2025 - December 14, 2025
...
comp_df <- read.csv(paste0(indir, 'spatial_components_2perc_2025-12-14.csv'))
clin_df <- read.csv(paste0(indir, 'prior_subjects_2025-09-19.csv'))
net_df <- read.csv(paste0(indir, 'FC_components_2perc_2025-12-14.csv'))
